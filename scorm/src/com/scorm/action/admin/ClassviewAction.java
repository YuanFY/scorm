...
@Component(value="classviewAction")
public class ClassviewAction extends ActionSupport{
	...
	//	System.out.println(dataCount);
		...
		//		System.out.println((pageStart -1 ) * page.getPageRecordNum()+","+ ((pageStart -1 ) * page.getPageRecordNum()+page.getPageRecordNum())+":::");
		    ...
		    xmlData = "<chart caption='按课程 平均得分统计' xAxisName='课程名' yAxisName='平均得分' showLabels='1' showvalues='0' decimals='0' numberPrefix=''>";
		    xmlData += "<categories>";
		   ...
		   for (Classstatisticinfo info : infolist) {
				xmlData+="<set value='"+info.getScoScore()+"' />";
	...
	//		System.out.println((pageStart -1 ) * page.getPageRecordNum()+","+ ((pageStart -1 ) * page.getPageRecordNum()+page.getPageRecordNum())+":::");
	    ...
	    xmlData = "<chart caption='按课件平均得分统计' xAxisName='课件名' yAxisName='平均得分' showLabels='1' showvalues='0' decimals='0' numberPrefix=''>";
	    xmlData += "<categories>";
		for (Classstatisticinfo info : infolist) {
