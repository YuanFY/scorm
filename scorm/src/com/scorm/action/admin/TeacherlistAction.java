...
@Component(value="teacherlistAction")
public class TeacherlistAction extends ActionSupport{
	...
	//ss	System.out.println("welcome 后台");
		dataCount = userinfoService.findAllTeacherinfo().size();
		...
		List<Userinfo> list = userinfoService.getTeacherList(pageStart, page.getPageRecordNum());
