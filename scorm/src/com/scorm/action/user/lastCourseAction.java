...
@Component(value="lastcourseAction")
public class lastCourseAction extends ActionSupport{
	/**分页
	 * 
	 */
...
//	String studyStatus;
	...
	public String execute(){
		...
		List<Studyrecordinfo> list = usercourseinfoService.getlastCourse(userId);
		if(list!=null){
			dataCount = list.size();
		}else{
			dataCount = 0;
	...
	//	System.out.println(courseType+"::"+courseName);
		...
		{
			list = usercourseinfoService.getlastCourse(userId);
		}
		else if(courseName.equals("")&&!courseType.equals("")){
			list = usercourseinfoService.getlastCourseByCourseType(courseType, userId);
		}
		else if(!courseName.equals("")&&courseType.equals("")){
			
			list = usercourseinfoService.getlastCourseByCourseName(courseName, userId);
		}else{
			list = usercourseinfoService.getlastCourseByAll(courseName, courseType, userId);
		}
