    ...
    <div class="extend-foot">
		<div class="group-list">
			...
			<%
				...
				List<UserFinish> list = utils.getAllCourse();
				request.setAttribute("totalCourse", list.size());
				request.setAttribute("courseList", list);
			%>
				<c:forEach var="m" items='${courseList }' begin="0" end="6"> 
				<li>
					<div class="group-pic">
						<a
		...
		<div class="pagination"
			...
			<span class="f_l f6"
				style="margin-right: 10px; margin-left: 10px">总计 <b>
				${requestScope.totalCourse }
			</b> 门课程，其中未完成<span style="color: red; font-weight: bold"> ${requestScope.totalCourse-requestScope.isFinish }
			</span> 门 </span>
				<c:if test="${request.totalCourse>6}">
				<a
				href="#"
