...
<title>IT学源网-我正在学习的课程</title>
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/user/${pageContext.request.contextPath }/user/css/style.css">
...
<div class="main">
	...
	<ul class="breadcrumb">
		...
		<li class="active"><a href="#">我正在学习的课程</a></li>
	</ul>
	...
	<ul class="nav nav-tabs" style="margin-bottom: 15px;">
               <li class="active"><a href="studyCourse.action">我正在学习的课程</a></li>
				<li><a href="endCourse.action">我已完成的在线课程</a></li>
				...
				<div id="myTabContent" class="tab-content" style="padding-left:0px">
				    <div class="tab-pane fade active in" id="lc">
						...
						<form action="searchStudy.action" method="get" class="form form-inline">
...
<!-- 								<th>学习进度</th> -->
						...
						<tr>
								...
								<td style="text-align: center; padding-left: 5px">&nbsp;<a class="de1" href="${pageContext.request.contextPath }/user/courseScoinfo.action?courseId=${m.courseId}&userId=${userinfo.userId}" title="${m.courseName}">${m.courseName}	</a>&nbsp;</td>
							
								<td style="text-align:center ">${m.courseType}</td>
								<td style="text-align:center ">${m.registerTime} 至
									${m.endTime}</td>
								<td style="text-align:center ">
								
							<c:if test="${ m.examRecord gt 60}">
								<span class="label label-success">
								通过
								</span>
							</c:if>
							<c:if test="${m.examRecord lt 60}">
				...
				<div class="pagination">
					<ul><li><a href="studyCourse.action?pageStart=1">首页</a></li>
					<li><a href="studyCourse.action?pageStart=${pageStart-1 }">上一页</a></li>
					<li><a href="studyCourse.action?pageStart=${pageStart+1 } ">下一页</a></li>
					<li><a href="studyCourse.action?pageStart=${pageStart-1}">末页</a></li></ul>
