...
<%@page import="com.scorm.vo.CourseregId"%>
...
String requestedSCO = (String)request.getSession().getAttribute( "scoID" );
//  Get the button that was pushed if its a button request
buttonType = (String)request.getSession().getAttribute( "button" );

System.out.println("cId="+cId+"---courseID="+courseID);
...
//  Execute the course info database query
	...
	System.out.println("userId="+userinfo.getUserId()+",courseId="+cId+",scoId="+courseID);
	List<Usercourseinfo> uclist1 = usercourseinfoService.returnUsercourseinfo(userinfo.getUserId(), cId, Integer.parseInt(courseID));
	System.out.println("ucList="+uclist1.size());
