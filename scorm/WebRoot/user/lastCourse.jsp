...
<div class="main">
	...
	<ul class="breadcrumb">
		...
		<li class="active"><a href="#">我已过期的课程</a></li>
	</ul>
	...
	<ul class="nav nav-tabs" style="margin-bottom: 15px;">
               <li ><a href="studyCourse.action">我正在学习的课程</a></li>
				...
				<li class="active"><a href="lastCourse.action">我已过期的在线课程</a></li>
				</ul>

<div id="myTabContent" class="tab-content" style="padding-left:0px">
    <div class="tab-pane fade active in" id="lc">
    					<div class="well well-small">
						<form action="lastCourse.action" method="get" class="form form-inline">
...
<!-- 								<th>学习进度</th> -->
						...
						<s:iterator value="infolist" var="list" id ="id">
							<tr>
								...
								<td style="text-align:center "><span class="label label-warning">
				...
				<div class="pagination">
					<ul><li><a href="lastCourse.action?pageStart=1">首页</a></li>
					<li><a href="lastCourse.action?pageStart=${pageStart-1 }">上一页</a></li>
					<li><a href="lastCourse.action?pageStart=${pageStart+1 } ">下一页</a></li>
					<li><a href="lastCourse.action?pageStart=${pageStart-1}">末页</a></li></ul>
