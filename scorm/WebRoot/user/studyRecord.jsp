...
<body class="typocn"><div class="" style="display: none; position: absolute;"><div class="aui_outer"><table class="aui_border"><tbody><tr><td class="aui_nw"></td><td class="aui_n"></td><td class="aui_ne"></td></tr><tr><td class="aui_w"></td><td class="aui_c"><div class="aui_inner"><table class="aui_dialog"><tbody><tr><td colspan="2" class="aui_header"><div class="aui_titleBar"><div style="cursor: move; display: block;" class="aui_title"></div><a style="display: block;" class="aui_close" href="javascript:/*artDialog*/;">×</a></div></td></tr><tr><td style="display: none;" class="aui_icon"><div style="background: none repeat scroll 0% 0% transparent;" class="aui_iconBg"></div></td><td style="width: auto; height: auto;" class="aui_main"><div style="padding: 20px 25px;" class="aui_content"></div></td></tr><tr><td colspan="2" class="aui_footer"><div style="display: none;" class="aui_buttons"></div></td></tr></tbody></table></div></td><td class="aui_e"></td></tr><tr><td class="aui_sw"></td><td class="aui_s"></td><td style="cursor: se-resize;" class="aui_se"></td></tr></tbody></table></div></div>
	<!-- header begin-->
				...
				<div class="nav-collapse collapse">
					<ul class="nav narbar-nav pull-left">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								<li><a href="${pageContext.request.contextPath }/user/getNoticeList.action">系统公告</a></li>
							</ul>
						</li>
						<li class="dropdown">
							<a data-toggle="dropdown"
	...
	<!-- header end-->
	<div class="clearfix"></div>
	<div style="top: 75px; margin-top: 75px;"></div>	<div class="container"><div class="main">
	<ul class="breadcrumb">
		<li><a href="${pageContext.request.contextPath }/user/user_index.jsp">首页</a><span class="divider">/</span></li>
		<li><a href="#">档案</a><span class="divider">/</span></li>
		<li class="active"><a href="#">我正的课程学习档案</a></li>
	</ul>
	...
	<div class="mcontent">
		<ul class="nav nav-tabs" style="margin-bottom: 15px;">
			<li class="active"><a href="studyRecord.action">我的课程学习档案</a></li>						
		</ul>
		<div id="myTabContent" class="tab-content" style="padding-left: 0px">
			<div class="tab-pane fade active in" id="hot_courses">
				<div class="well well-small">
					<form action="searchRecord.action" method="get" class="form form-inline">
						<input name="courseName" onfocus="this.select();" class="span3" type="text">
						<span><select name="courseType" class="input-medium">
...
<!-- 							<th>学习进度</th> -->
					...
					<s:iterator value="infolist" var="list" id="id">
						<tr>
							<td  style="text-align: center;"><a href="${pageContext.request.contextPath }/user/courseScoinfo.action?courseId=${id.courseId}&userId=${userinfo.userId}" title="${courseName} ">
						<s:property value="courseName" />		</a><br> 
							<td  style="text-align: center;">
					<s:property value="courseType" />	 </td>
							<td  style="text-align: center;"><s:property value="registerTime" />	  至 <br>
					<s:property value="endTime" /></td>
<!-- 							<td> -->
<!-- 								<div class="progress progress-striped active" style="margin-top: 6px"> -->
<!-- 									<div class="bar" style="width: 90%;">90%</div> -->
<!-- 								</div> -->
<!-- 							</td> -->
							<td  style="text-align: center;"><s:property value="studyTime" /></td>
							<td  style="text-align: center;"><s:property value="lastTime" /></td>
							<td  style="text-align: center;">
				<s:property value="examRecord" /></td>
				...
				<div class="pagination">
					<ul><li><a href="studyRecord.action?pageStart=1">首页</a></li>
					<li><a href="studyRecord.action?pageStart=${pageStart-1 }">上一页</a></li>
					<li><a href="studyRecord.action?pageStart=${pageStart+1 } ">下一页</a></li>
					<li><a href="studyRecord.action?pageStart=${pageStart-1}">末页</a></li></ul>
