											...
											<table width="100%" border="0" cellspacing="0"
												...
												<tr>
													...
													<td width="40%" class="STYLE1">
														...
														<span class="STYLE3">当前位置</span>：[人员管理]-[教师管理]
													</td>
												</tr>
											</table>
										</td>
...
<s:form action="changeTeacher" namespace="/" method="post">
			<div id="errorlist">
			</div>
