...
#button {
	...
	<body>
		...
		<s:if test="#session.updateResult">
			<script>
				alert('修改成功');
			</script>
			<%
...
jQuery(document).ready(function($) {
    $('#button').click(function empty()
    {
		...
		<s:form action="addCourseType" method="post">
			<div id="errorlist">
			</div>
			<table border="0px" style="font-size: 12px" width="100%">
				<tr>
					...
					<td width="265">
						<input type="text" size="26" name="courseTypeId" readOnly/>
					</td>
				</tr>
				...
				<tr>
					...
					<td width="265">
						<input type="text" size="26" id="courseType" name="courseType" title="课程类型名字不能为空"/>
					</td>
					<td width="330">
