...
<s:form action="updateCourseinfo" namespace="/" encType="multipart/form-data" method="post">
			<div id="errorlist">
			</div>
			<table border="0px" style="font-size: 12px" width="100%">
				<tr>
					...
					<td width="265">
						<input type="text" size="26" name="courseId" value="${ courseinfo.courseId}" readOnly/>
					</td>
				...
				<tr>
					...
					<td width="265">
						<input type="text" size="26" id="courseName" name="courseName" title="课程名称不能为空" value="${courseinfo.courseName}"  />
					</td>
					<td width="330">
					...
					<td width="265">
						<select size="1" name="courseType">
							<s:iterator value="#session.coursetypeinfoList" var="course">
								<option value=<s:property value="#course.courseTypeId"/> <%= ((Courseinfo)request.getSession().getAttribute("courseinfo")).getCourseType().equals(((Coursetypeinfo)request.getAttribute("course")).getCourseType()) ? "selected" : "" %>>
				...
				<tr>
					...
					<td width="265">
						<input type="text" size="26" name="registerNumber" value="${courseinfo.registerNumber }" id="registerNumber" readOnly/>
					</td>
					<td  width="330">
			    ...
			    <tr>
					...
					<td width="265">
						<input type="text" size="26" name="uploadTime" value="${fn:substring(courseinfo.uploadTime,0,19) }" id="uploadTime" readOnly/>
					</td>
					<td  width="330">
				...
				<tr>
					...
					<td width="265">
						<textarea name="courseContent" rows="10" cols="24" style="resize:none">${courseinfo.courseContent }</textarea>
					</td>
					<td  width="330">
						<p id="contentTip" style="width: 280px" ><font color="red"></font></p>
					</td>
				</tr>
				<tr>
					<td align="right" width="135">
				...
				<tr>
					...
					<td width="265">
						<img src="${pageContext.request.contextPath }/${courseinfo.coursePicture }" style="width:200px; height:200px"/>
					</td>
				</tr>
