...
jQuery(document).ready(function($) {
    $('#button').click(function empty()
    {
		...
		<s:form action="updateNoticeinfo" method="post">
			<div id="errorlist">
			</div>
			<table border="0px" style="font-size: 12px" width="100%">
				<tr>
					...
					<td width="265">
						<input type="text" size="26" name="noticeId" value="${noticeinfo.noticeId}" readOnly/>
					</td>
				</tr>
				...
				<tr>
					...
					<td width="265">
						<input type="text" size="26" id="noticeTitle" name="noticeTitle" title="公告标题不能为空" value="${noticeinfo.noticeTitle}"  />
					</td>
					<td width="330">
				...
				<tr>
					...
					<td width="265">
						<input type="text" size="26" id="noticeContent" name="noticeContent" title="公告内容不能为空" value="${noticeinfo.noticeContent}"  />
					</td>
					<td width="330">
				...
				<tr>
					...
					<td width="265">
						<input type="text" size="26" id="noticeTime" name="noticeTime" title="公告时间不能为空" value="${fn:substring(noticeinfo.noticeTime,0,19) }" readOnly />
					</td>
					<td width="330">
						<p id="noticeTimeTip" style="width: 280px"><font color="red"></font></p>
					</td>
				</tr>
